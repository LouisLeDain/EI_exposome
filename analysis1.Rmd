...
Code générique pour évaluer le lien entre phénotype et exposition

```{r}
fit0 = glm(asthma~h_cohort , family = "binomial", data  = df)
fit1 = glm(asthma~h_cohort + h_abs_ratio_preg_Log, family = "binomial", data  = df)
